...
echo "Instalando Docker" && sudo apt-get install -y docker.io >> /dev/null

clear
echo "Baixando Imagens: 1 de 8" && sudo docker pull walafi02/dvl-seguranca-cliente
...
clear
echo "Baixando Imagens: 2 de 8" && sudo docker pull walafi02/dvl-seguranca-servidor
...
clear
echo "Baixando Imagens: 3 de 8" && sudo docker pull walafi02/dvl-tcpip-cliente
...
clear
echo "Baixando Imagens: 4 de 8" && sudo docker pull walafi02/dvl-tcpip-servidor
...
clear
echo "Baixando Imagens: 5 de 8" && sudo docker pull walafi02/dvl-bd-cliente
...
clear
echo "Baixando Imagens: 6 de 8" && sudo docker pull walafi02/dvl-bd-servidor
...
clear
echo "Baixando Imagens: 7 de 8" && sudo docker pull walafi02/dvl-ubuntu-base
...
clear
echo "Baixando Imagens: 8 de 8" && sudo docker pull walafi02/dvl-ubuntu-completo
